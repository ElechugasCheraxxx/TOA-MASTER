    ...
    const setupLogic = () => {
        ...
        const render = () => {
            ...
            if (val === 'validacion') {
                ...
                html = `
                    ...
                    <input type="text" id="rp-fecha" placeholder="Nueva Fecha (DD/MM - AM1)" style="margin-top:5px">
        ...
        document.getElementById('btn-gen').onclick = () => {
            ...
            if (cat === 'validacion') {
                ...
                // [cite: 370-377]
                if (act === 'ciclo') {
                    const extra = document.getElementById('s-input-extra').value;
                    ...
                    const sup = document.getElementById('s-input-extra').value;
                ...
                if(mot.includes("DUPLICIDAD")) {
                    txt += `\nSE ATENDIÓ CON SOT: ${document.getElementById('r-dupli').value}`;
                }
            } else if (cat === 'repro') {
                // [cite: 308-312]
